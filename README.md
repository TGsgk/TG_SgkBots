...
分享一些免费好用的 Telegram电报社工库机器人 和 在线社工库查询网站，可查询平台帐号、密码、邮箱、手机号、身份证等各种隐私数据是否泄露，看看你是否也处于数据外泄事件之中。
...
注意：以下社工库机器人均需要VPN软件和Telegram配合下才能使用
...
付费社工库一般是未充值的时候查询只会返回带*号的数据，需要充值才能解锁看到具体信息，但对自查个人信息是否泄露够用了。
...
姓名-地区-性别 搜索test2 张雪 河南省郑州市金水区 女

姓名-年龄范围搜索test3 张雪 18 29

模糊姓名-精确生日搜索test6 张x 19710101

精确姓名-模糊18位身份证搜索test7 张雪 xxxx2420001005xxxx

模糊姓名-模糊18位身份证搜索test9 张x 320324xxxxxxxx0018
